...
<div class="gtco-section-v">
	<div class="gtco-container">
		...
		<div class="row">
			...
			<form action="regLessonDetail" method="post">
				<input type="hidden" name="l_num" value="${l_num }">
				<div class="form-group">
					<span class="notnull">*</span><label for="l_location">레슨 지역</label> 
					<input type="text" class="form-control" name="l_location">
				</div>
				<div class="form-group">
					<label for="l_room">레슨 장소</label> 
					<input type="text" class="form-control" name="l_room">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<textarea class="form-control txtarea" name="l_content" placeholder="간단한 자기 소개와 레슨 진행 계획, 내용 등을 작성해 주세요." rows="10"></textarea>
					
				</div>
				<div class="form-group">
					<span class="notnull">*</span><label for="l_pay">레슨 비용(시간 당)</label> 
					<input type="number" class="form-control" name="l_pay">
				</div>
				<div class="form-group">
