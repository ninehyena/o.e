...
<div class="gtco-section">
    ...
    <form name="fregister" id="fregister" action="signup" onsubmit="return fregister_submit(this);" method="POST" autocomplete="off">
    ...
    <div id="fregister_chkall" class="checks2">
        ...
        <label for="chk_all" style="margin-bottom: 0">회원가입 약관에 모두 동의합니다</label>
    </div>

    <section id="fregister_term">
		<div class="fregister_agree2 checks2">            
            <input type="checkbox" name="agree" value="1" id="agree11">
			<label for="agree11" style="margin-bottom: 0">이용약관 동의<span>(필수)</span></label>
        </div>
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
    ...
    <section id="fregister_private">
        <fieldset class="fregister_agree2 checks2">            
			...
			<label for="agree21" style="margin-bottom: 0">개인정보 수집 및 이용 동의<span>(필수)</span></label>
        </fieldset>
...
2) 시행일자 : 2018년 05월 01일 </textarea>
    ...
    <div class="btn_confirm">
		<a href="/e" class="btn_cancel">CANCEL</a>
